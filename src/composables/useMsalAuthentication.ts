// Source AzureAD sample https://github.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/samples/msal-browser-samples/vue3-sample-app/src/composition-api/useMsalAuthentication.ts
// Slightly modified to abide by the TypeScript rules
